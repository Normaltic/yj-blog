...
![사진 1) Cannot shared between components](../images/use_sync_localstorage/cannot_shared_local_storage.gif)
...
![사진 2) Sharing update with custom event](../images/use_sync_localstorage/sharing_update_with_event.gif)
...
![사진 3) Sharing update with useSyncExternalStore](../images/use_sync_localstorage/sharing_update_with_ses_counter.gif)
...
![사진 4) Infinite loop during rendering](../images/use_sync_localstorage/infinite_loop_updated.png)
...
![사진 5) ArrayController works well](../images/use_sync_localstorage/array_controller_work_well.gif)
...
![사진 6) Sharing update with storage event](../images/use_sync_localstorage/sharing_update_with_multiple_tab.gif)
...
![사진 7) Sharing update with useSyncLocalStorage](../images/use_sync_localstorage/sharing_update_with_general.gif)
...
옵션을 묶어 세 번째 파라미터로 전달 받도록 하고, 각 옵션을 `useRef`를 통해 참조하도록 했다. 이렇게 하면 밖에서 memoization되지 않은 함수를 전달해도, 처음 전달된 함수를 호출할 수 있게 된다.
...
![사진 8) Typeguard failed](../images/use_sync_localstorage/cannot_parse_key_of_local_storage_error.png)
...
![사진 9) Map Controller](../images/use_sync_localstorage/map_in_local_storage.gif)
