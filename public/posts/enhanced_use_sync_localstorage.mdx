...
```tsx title="useLocalStorageWithEvent.tsx"
...
```tsx title="useLocalStorageWithExternalStore.tsx"
...
```tsx title="useLocalStorageWithListener.tsx" showLineNumbers
...
```tsx title="useSyncLocalStorage.tsx" showLineNumbers
